...
class AirlineCompany(models.Model):
    ...
    icon = FilerImageField(verbose_name='Logo icon 50x50', related_name='icon', blank=True, null=True, on_delete=SET_NULL)
    logo = FilerImageField(verbose_name='Logo image [large]', related_name='logo', blank=True, null=True, on_delete=SET_NULL)
